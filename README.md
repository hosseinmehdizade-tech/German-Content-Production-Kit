...
The active production framework is **v3.3.2 — Menschen Course Export Ready**. GitHub is the compact durability/coordination mirror; the exact verified portable framework candidate is stored in ChatGPT Library and identified by SHA-256 in `PROJECT-STATE.json`.
...
Current Menschen workstream: `Workspaces/menschen-a1a2b1-memrise/`. **A1-L01 through A1-L05 are LOCKED.** A1-L05 completed all seven stages on GFP v417/R51 with 119 cards, Stage 4 at 29/29 PASS, exact final outer-bundle runtime acceptance at 23/23 PASS and 119/119 standalone persistence. The cumulative L01-L05 collision gate is 481 unique IDs with zero collisions. A single sequential 481-card durable-persistence run is intentionally not claimed because of the documented managed-browser environment boundary. Next scope: **A1-L06 Stage 1/2**.
