...
GEN=json.loads((ROOT/'Workspaces/menschen-a2/tools/RESIDUAL-PEDAGOGICAL-EXAMPLES-v1.json').read_text(encoding='utf-8'))
...
u={'id':'ma2-lu-0187','type':'verb','headword':'vorstellen','definition_de':'etwas nach vorne stellen','examples':[
 ...
 {'id':'ma2-lu-0187-ex-004','lang':'de-DE','text':GEN['items']['ma2-lu-0187'][0]['text'],'order':4,'translations':[]}
...
bad=m.generated_texts(ROOT/'Workspaces/menschen-a2/tools/RESIDUAL-PEDAGOGICAL-EXAMPLES-v1.json')
